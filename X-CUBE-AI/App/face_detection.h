...
#ifndef AI_FACE_DETECTION_H
#define AI_FACE_DETECTION_H
#pragma once
...
#define AI_FACE_DETECTION_INPUTS_IN_ACTIVATIONS   (4)
#define AI_FACE_DETECTION_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_FACE_DETECTION_IN_NUM        (1)

AI_DEPRECATED
#define AI_FACE_DETECTION_IN \
  ai_face_detection_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_FACE_DETECTION_IN_SIZE { \
  AI_FACE_DETECTION_IN_1_SIZE, \
}
...
AI_DEPRECATED
#define AI_FACE_DETECTION_OUT \
  ai_face_detection_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_FACE_DETECTION_OUT_SIZE { \
  AI_FACE_DETECTION_OUT_1_SIZE, \
}
 ...
 * @ref ai_face_detection_create. Both the activations memory buffer 
 ...
 * using @ref ai_face_detection_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_face_detection_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_face_detection_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_FACE_DETECTION_*
 * defines into file @ref face_detection.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_face_detection_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_FACE_DETECTION_H */
