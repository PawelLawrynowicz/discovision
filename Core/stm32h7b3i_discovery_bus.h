/**
  ******************************************************************************
  * @file    stm32h7b3i_discovery_bus.h
...
#ifndef STM32H7B3I_DK_BUS_H
#define STM32H7B3I_DK_BUS_H
...
/** @addtogroup STM32H7B3I_DK_BUS
  * @{
  */
/** @defgroup STM32H7B3I_DK_BUS_Exported_Types Exported Types
  * @{
  */
...
/** @defgroup STM32H7B3I_DK_BUS_Exported_Constants Exported Constants
  * @{
  */
...
/** @addtogroup STM32H7B3I_DK_BUS_Exported_Variables
  * @{
  */
...
/** @defgroup STM32H7B3I_DK_BUS_Exported_FunctionsPrototypes Exported Functions Prototypes
  * @{
  */
